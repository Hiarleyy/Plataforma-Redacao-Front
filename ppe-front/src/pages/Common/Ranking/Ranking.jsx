    ...
    <div className={styles.container}>
      ...
      <div className={styles.main_content}>
        <div className={styles.podium}>
          ...
          {ranking[1] && <h3>{ranking[1].nome}</h3>}
          {ranking[1] && <p>{ranking[1].media}</p>}
          </div>
          ...
          {ranking[0] && <h3>{ranking[0].nome}</h3>}
          {ranking[0] && <p>{ranking[0].media}</p>}
          </div>
          <div className={styles.position_container}>
          ...
          {ranking[2] && <h3>{ranking[2].nome}</h3>}
          {ranking[2] && <p>{ranking[2].media}</p>}
          </div>
        </div>
